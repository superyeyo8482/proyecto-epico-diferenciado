...
# Versión 3 - 10 noticias importantes, eco completo
...
def extraer_titulares(texto):
    ...
    for linea in lineas:
        linea = linea.strip()
        if len(linea) > 10 and (linea[0].isupper() or linea[0].isdigit()):
...
if __name__ == "__main__":
    print("🚀 Iniciando Analizador de Noticias V3...")
    root = tk.Tk()
