...
class AnalizadorGUI:
    ...
    def crear_widgets(self):
        titulo = tk.Label(self.root, text="📰 Analizador de Noticias · Lux Vinculum", font=("Playfair Display", 18, "bold"), fg="#C9A84C", bg="#0a0a12")
        titulo.pack(pady=10)
        ...
        tk.Button(btn_frame, text="📄 Cargar PDF (OCR)", command=self.cargar_pdf, bg="#C9A84C", fg="#0a0a12", font=("Inter", 10, "bold"), padx=15, pady=5).pack(side=tk.LEFT, padx=5)
        tk.Button(btn_frame, text="📂 Cargar TXT", command=self.cargar_archivo, bg="#2a7a5a", fg="white", font=("Inter", 10, "bold"), padx=15, pady=5).pack(side=tk.LEFT, padx=5)
        tk.Button(btn_frame, text="🔍 Analizar", command=self.ejecutar_analisis, bg="#C9A84C", fg="#0a0a12", font=("Inter", 10, "bold"), padx=15, pady=5).pack(side=tk.LEFT, padx=5)
        tk.Button(btn_frame, text="💾 Guardar Reporte", command=self.guardar_reporte, bg="#2a7a5a", fg="white", font=("Inter", 10, "bold"), padx=15, pady=5).pack(side=tk.LEFT, padx=5)
        ...
        self.texto_preview = scrolledtext.ScrolledText(left_frame, height=30, bg="#1a1a2e", fg="#e0e0e0", insertbackground="#C9A84C", font=("Courier", 9))
        ...
        self.resultados_texto = scrolledtext.ScrolledText(right_frame, height=30, bg="#1a1a2e", fg="#e0e0e0", insertbackground="#C9A84C", font=("Courier", 9))
    ...
    def ejecutar_analisis(self):
        ...
        # Filtrar importantes
        importantes = sorted([r for r in self.resultados if "ALTO" in r["nivel"] or "MEDIO" in r["nivel"]], key=lambda x: x["eco"], reverse=True)[:6]
